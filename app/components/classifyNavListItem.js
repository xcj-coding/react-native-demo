...
export default class ClassifyNavListItem extends Component {
	...
	render() {
		return (
			<View style={this.props.initTypeId === this.props.typeId ? [styles.list_item,styles.list_item_select] : styles.list_item}>
				<Text 
					onPress={()=>{
						let dataId = this.props.typeId
						this.props.selectFn(dataId)
					}}
