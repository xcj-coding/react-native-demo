...
import { View, Text, Image, Modal, TouchableHighlight, DatePickerAndroid, TimePickerAndroid, DatePickerIOS, Platform, Animated, StyleSheet } from 'react-native';
...
DatePicker.defaultProps = {
    ...
    confirmBtnText: '确定',
    cancelBtnText: '取消',
    iconSource: require('../../res/data.png'),
    customStyles: {},
