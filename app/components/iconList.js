              ...
              contain.map((e, i) => (
                <View style={styles.container} key={i}>
                {
                  this.props.tabs.filter((ele, _index) => {
                    ...
                    <TouchableOpacity style={[styles.itemWrapper, {width: itemWidth, height: itemHeight}]}
                      key={index} onPress={ () => { this.props.onPress && this.props.onPress((i) *nums + index) }}>
                      <Image
                        source={{uri: cate.img}}
                        style={{
                          width: imgW,
